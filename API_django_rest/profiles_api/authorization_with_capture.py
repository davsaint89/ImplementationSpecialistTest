...
config_file = '/home/david/Documents/API_django_rest/cybersource-rest-samples-python/data/Configuration.py'#os.path.join(os.getcwd(), "data", "Configuration.py")
...
def authorization_with_capturesale():
    ...
    orderInformationBillToFirstName = "Adam"
    orderInformationBillToLastName = "jimenes"
    ...
    try:
        ...
        return body#return_data
    except Exception as e:
        print("\nException when calling PaymentsApi->create_payment: %s\n" % e)

def authorization_with_capturesale_trig_rej():
    clientReferenceInformationCode = "TC50171_3"
    clientReferenceInformation = Ptsv2paymentsClientReferenceInformation(
        code = clientReferenceInformationCode
    )
    ...
    orderInformationBillToFirstName = "Chris"
    orderInformationBillToLastName = "Evans"
    orderInformationBillToAddress1 = "1 Market St"
    orderInformationBillToLocality = "san francisco"
    orderInformationBillToAdministrativeArea = "CA"
    orderInformationBillToPostalCode = "94105"
