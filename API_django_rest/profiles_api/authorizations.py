...
def simple_authorizationinternet(flag):
    ...
    orderInformationBillToFirstName = "Mardoqueo"
    orderInformationBillToLastName = "Perlaza"
...
def capture_payment():
    ...
    api_payment_response = simple_authorizationinternet(False)
...
def refund_payment():
    api_payment_response = simple_authorizationinternet(True)
    id = api_payment_response.id
